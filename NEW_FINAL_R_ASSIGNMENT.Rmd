...
The indeterminacy of this study, regarding the influence of environmental variables on the biology of *I.digitata*, may be attributed to the employment of pseudoreplicates in the collected dataset. In addition to this results were constrained by limiting the sampling sites to two locations. This ultimately resulted in little to no variation in the data between the two sites, possibly affecting the outcomes of our statistical analyses. As a result of this we find that the results of our analysis are inadequate in explaining the relationship that both physical and chemical environmental parameters have on the accumulation of biomass in *I.digitata*. Despite a weakened potential of the data as a result of pseudoreplication, data was still capable of revealing differences in both the chemical and physical parameters of the Krom River between the two sites. Future studies would need to include a greater number of sampling sites in conjunction with a higher number of replicates derived from each of the sites, if we wish to better understand the dynamics of environmental variables of the biology of the submerged macrophyte *I.digitata*.