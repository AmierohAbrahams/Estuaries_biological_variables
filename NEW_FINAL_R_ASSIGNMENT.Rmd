...
H0: The accumulation of biomass of *I.digitata* is independant of physical (temperature and depth) and chemical(pH, total dissolved solid[TDS] and total dissolved oxygen).
...
Plotting the correlation matrix. This provides a graphical representation of all the environmental variables investigated in this study (both chemical and physical) and their relationship with the accumulation of biomass of the submerged macrophyte *I.digitata*.
