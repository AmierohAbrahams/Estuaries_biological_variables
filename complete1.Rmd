...
H0: The accumulation of biomass of *I.digitata* is independant of physical (temeprature and depth) and chemical(pH, total dissolved solid[TDS] and total dissolved oxygen).

H1: The accumulation of biomass of *I.digitata* is dependant on physical (temeprature and depth) and chemcial(pH, total dissolved solid[TDS] and total dissolved oxygen)
...
Here we create a correlation matrix to compare each of the parameters between eachother.
