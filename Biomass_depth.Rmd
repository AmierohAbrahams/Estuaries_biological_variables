...
PLOT3 <- ggplot(data = R_assignment_AJ_, aes(y = Macrophyte_Biomass , x = Dissolved_oxygen)) +
  geom_point(aes(colour = Site)) +
  geom_smooth(aes(colour = Site), method = "lm") +
  coord_equal(xlim = c(0, 60), ylim = c(0,60)) +
...
PLOT4 <- ggplot(data = R_assignment_AJ_, aes(y = Macrophyte_Biomass , x = pH)) +
  geom_point(aes(colour = Site)) +
  geom_smooth(aes(colour = Site), method = "lm") +
  coord_equal(xlim = c(0, 60), ylim = c(0,60)) +
...
PLOT5 <- ggplot(data = R_assignment_AJ_, aes(y = Macrophyte_Biomass , x = Temperature)) +
  geom_point(aes(colour = Site)) +
  geom_smooth(aes(colour = Site), method = "lm") +
  coord_equal(xlim = c(0, 60), ylim = c(0,60)) +
  labs(x = "Macrophyte Biomass (g)", y = "Temperature (°C)") +
    theme_AJMS()
